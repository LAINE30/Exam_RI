...
class VectorDB:
    ...
    """
    def __init__(self, db_dir: str = "data/chroma_db", collection_name: str = "arxiv_corpus"):
        """
    ...
    def index_documents(self, ids: List[str], embeddings: List[List[float]], documents: List[str], metadatas: List[Dict[str, Any]]):
        ...
        Args:
            ...
            embeddings: Lista de listas de floats (los vectores de Gemini).
            documents: Lista de textos del corpus.
            metadatas: Lista de diccionarios con metadatos (ej. URL del paper, tópicos).
        """
    ...
    def search(self, query_embedding: List[float], top_k: int = 5) -> Dict[str, Any]:
        ...
        Args:
            query_embedding: El vector generado para la consulta del usuario.
